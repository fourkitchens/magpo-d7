 ...
 * 1. Rename each function and instance of "at_magpo" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "at_magpo".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within at_magpo_preprocess_html(), there
 ...
 */
function at_magpo_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'at_magpo.responsive.style.css',
    'at_magpo.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'at_magpo');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'at_magpo');
  // */
...
function at_magpo_process_html(&$vars) {
}
// */
...
function at_magpo_preprocess_page(&$vars) {
}

function at_magpo_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function at_magpo_preprocess_node(&$vars) {
}

function at_magpo_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function at_magpo_preprocess_comment(&$vars) {
}

function at_magpo_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function at_magpo_preprocess_block(&$vars) {
}

function at_magpo_process_block(&$vars) {
}
// */
