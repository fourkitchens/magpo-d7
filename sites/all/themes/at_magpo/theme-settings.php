...
/**
 * USAGE:
 * 1 - To use this file replace "at_magpo" with the name of
...
// Replace 'at_magpo' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function at_magpo_form_system_theme_settings_alter(&$form, &$form_state)  {
